    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Редактирование категории отрасли</h1>
                    <p class="mt-1 text-sm text-gray-500">Обновите информацию о категории</p>
                </div>
            </div>
            <div class="flex items-center space-x-2">
                <span
                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $industryCategory->is_active ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" name="icon" id="icon"
                                    value="{{ old('icon', $industryCategory->icon) }}" placeholder="business"
                ...
                <div class="flex items-center justify-center">
                    <div class="flex items-center p-6 bg-gray-50 rounded-xl border-2 border-dashed border-gray-300">
                        <div class="flex-shrink-0 h-16 w-16 rounded-xl flex items-center justify-center text-white text-2xl shadow-lg"
                            id="preview-color" style="background-color: {{ old('color', $industryCategory->color) }}">
                            <i class="material-icons"
                                id="preview-icon">{{ old('icon', $industryCategory->icon) ?: 'business' }}</i>
                        </div>
                        <div class="ml-6">
                            <div class="text-lg font-semibold text-gray-900" id="preview-name">
                                {{ old('name', $industryCategory->name) ?: 'Название категории' }}
                            </div>
                            <div class="text-sm text-gray-500" id="preview-slug">
                                Слаг: {{ old('slug', $industryCategory->slug) ?: 'slug' }}
                            </div>
