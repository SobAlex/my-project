...
@section('content')
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Создание кейса</h1>
                    <p class="mt-1 text-sm text-gray-500">Заполните информацию о новом кейсе</p>
                </div>
            </div>
        </div>
    </div>

    <form action="{{ route('admin.cases.store') }}" method="POST" class="space-y-8">
        @csrf
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="metric_name_{{ $i }}"
                                        value="{{ old('metric_name_' . $i, '') }}" placeholder="например: traffic"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="metric_before_{{ $i }}"
                                        value="{{ old('metric_before_' . $i, '') }}" placeholder="2,500"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="metric_after_{{ $i }}"
                                        value="{{ old('metric_after_' . $i, '') }}" placeholder="12,000"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Dynamic creation of before_after fields for metrics
