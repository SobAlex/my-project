...
<body>
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div x-data="{ callbackOpen: false }" @open-callback.window="callbackOpen = true"
            @keydown.escape.window="callbackOpen = false">
            <div x-show="callbackOpen" x-transition.opacity
                ...
                <!-- Диалог -->
                <div class="relative bg-white w-full max-w-md mx-4 rounded shadow-lg p-6" role="dialog"
                    aria-modal="true" aria-labelledby="callback_title">
                    <div class="flex items-start justify-between mb-4">
                        <h3 id="callback_title" class="text-xl font-semibold">Заказать звонок</h3>
                        <button class="text-gray-500 hover:text-gray-700" aria-label="Закрыть"
           ...
           lg:grid-cols-4 lg:gap-6">
                    ...
                    <article class="element-bg shadow flex flex-col">
                        ...
                        <div class="flex flex-col flex-[2] p-4">
                            ...
                            <div class="mt-auto mb-4">
                                <button class="btn self-center"
                                    onclick="openServiceOrderModal('Аудит КФ')">Заказать</button>
                            </div>
                        </div>
                        {{-- End card service top --}}
                    ...
                    <article class="element-bg shadow flex flex-col">
                        ...
                        <div class="flex flex-col flex-[2] p-4">
                            ...
                            <div class="mt-auto mb-4">
                                <button class="btn self-center"
                                    onclick="openServiceOrderModal('Аудит ПФ')">Заказать</button>
                            </div>
                        </div>
                        {{-- End card service top --}}
    ...
    <div id="serviceOrderModal" class="fixed inset-0 z-50 flex items-center justify-center" style="display: none;">
        ...
        <div class="relative bg-white w-full max-w-lg mx-4 rounded shadow-lg p-6" role="dialog" aria-modal="true"
            ...
            <form action="{{ route('service.order') }}" method="POST" class="space-y-4"
