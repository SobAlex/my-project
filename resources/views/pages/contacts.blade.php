                ...
                <div class="space-y-8">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg">{{ $contactInfo['address'] }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <a href="tel:{{ str_replace(' ', '', $contactInfo['phone']) }}"
                                class="text-cyan-600 hover:text-cyan-700 text-lg font-medium">
                                {{ $contactInfo['phone'] }}
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-lg">{{ $contactInfo['working_hours'] }}</p>
                        </div>
                    </div>
                </div>
