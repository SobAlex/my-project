    ...
    <div
        ...
        <article
            ...
            <div class="flex flex-col flex-[2] p-4">
                ...
                <div class="mt-auto mb-4">
                    <button class="btn self-center" onclick="openServiceOrderModal('SEO продвижение сайта')">Заказать</button>
                </div>
            </div>
        ...
        <article class="element-bg shadow flex flex-col">
            ...
            <div class="flex flex-col flex-[2] p-4">
                ...
                <div class="mt-auto mb-4">
                    <button class="btn self-center" onclick="openServiceOrderModal('Технический аудит')">Заказать</button>
                </div>
            </div>
            {{-- End card service top --}}
        ...
        <article class="element-bg shadow flex flex-col">
            ...
            <div class="flex flex-col flex-[2] p-4">
                ...
                <div class="mt-auto mb-4">
                    <button class="btn self-center" onclick="openServiceOrderModal('Ссылочный профиль')">Заказать</button>
                </div>
            </div>
            {{-- End card service top --}}
        ...
        <article class="element-bg shadow flex flex-col">
            ...
            <div class="flex flex-col flex-[2] p-4">
                ...
                <div class="mt-auto mb-4">
                    <button class="btn self-center" onclick="openServiceOrderModal('Сбор и группировка СЯ')">Заказать</button>
                </div>
            </div>
            {{-- End card service top --}}
        ...
        <article class="element-bg shadow flex flex-col">
            ...
            <div class="flex flex-col flex-[2] p-4">
                ...
                <div class="mt-auto mb-4">
                    <button class="btn self-center" onclick="openServiceOrderModal('Составление SEO стратегии')">Заказать</button>
                </div>
            </div>
            {{-- End card service top --}}
